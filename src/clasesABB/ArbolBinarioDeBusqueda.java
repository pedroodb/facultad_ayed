...
/*	public void eliminar(T dato) {
		...
		else if (this.getDatoRaiz().compareTo(dato)>0){
			this.getHijoIzquierdo().eliminar(dato);
		}
		else this.getHijoDerecho().eliminar(dato);
	}
	
	public void eliminar(ArbolBinarioDeBusqueda abb){
